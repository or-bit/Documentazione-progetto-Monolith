...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{./Diagrammi_img/usecase/uc_todo.png}
	\caption{Casi d'uso Bubble To-do list}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/usecase/uc2_1.png}
	\caption{\UCCaption{} Creare una lista}
\end{figure}

%\begin{figure}[H]
%	\centering
%	\includegraphics[height=10cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/attivita/uc_todo_crea_lista.png}
%	\caption{Diagramma di attività - Creare una lista}
%\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/usecase/uc2_2.png}
	\caption{\UCCaption{} Aggiungere elemento alla to-do list}
\end{figure}

%\begin{figure}[H]
%	\centering
%	\includegraphics[height=10cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/attivita/uc_todo_aggiungere_elem.png}
%	\caption{Diagramma di attività - Aggiungere elemento alla to-do list}
%\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/usecase/uc2_3.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/usecase/uc2_4.png}
	\caption{\UCCaption{} Possibilità di mettere un reminder come notifica statica}
\end{figure}

%\begin{figure}[H]
%	\centering
%	\includegraphics[height=10cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/attivita/uc_todo_notifica.png}
%	\caption{Diagramma di attività - Possibilità di mettere un reminder come notifica statica}
%\end{figure}
