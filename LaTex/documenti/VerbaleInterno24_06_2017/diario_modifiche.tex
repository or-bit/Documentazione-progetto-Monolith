...
\begin{longtable}{|>{\centering}P{0.9cm}|>{\centering}P{1.7cm}|>{\centering}P{2.9cm}|>{\centering}P{2.5cm}|P{4cm}|}
	...
	\hline 1.0.0 & 25-06-2017 & \bea & \Responsabile & Approvazione del documento \\
	
	\hline 0.1.0 & 24-06-2017 & \alice & \Verificatore & Verifica del documento \\ 

	\hline 0.0.1 & 24-06-2017 & \mattia & \Amministratore & Creazione e stesura documento \\ 
	\hline 
