...
%\afterpage{
\clearpage
\newgeometry{margin=1.5cm}	\label{analisiRischi}
\begin{landscape}% Landscape page
	...
	\begin{longtable}{|P{3cm}|P{2cm}|P{2cm}|P{3cm}|P{3cm}|P{4cm}|P{3cm}|P{3.5cm}|}
		...
		& & & & & & \VV & Necessario incremento delle ore di codifica per terminare componenti del framework \\ \cline{7-8}
		...
		& & & & & & \VV & Necessario riassegnamento dei ruoli per aumentare le ore dedicate ai programmatori \\ \cline{7-8}
