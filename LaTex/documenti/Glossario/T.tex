...
Tool di \glossario{project management} disponibile online. Permette di gestire  task, tickets e \glossario{milestones} ed è dotato di strumenti per il tracciamento del tempo di lavoro.
...
Il termine TextEdit definisce una casella di testo editabile. È un \glossario{elemento di input} che fornisce all’utente la possibilità di inserire un un dato di tipo testuale.
