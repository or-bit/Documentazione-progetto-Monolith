...
\begin{longtable}{|>{\centering}P{0.9cm}|>{\centering}P{1.7cm}|>{\centering}P{2.9cm}|>{\centering}P{2.5cm}|P{4cm}|}
	...
	\hline 1.0.0 & 18-06-2017 & \nick & \Responsabile & Approvazione del documento \\
	
	\hline 0.1.0 & 18-06-2017 & \alice & \Verificatore & Verifica del documento \\ 

	\hline 0.0.1 & 18-06-2017 & \marco & \Amministratore & Creazione e stesura documento \\ 
	\hline 
