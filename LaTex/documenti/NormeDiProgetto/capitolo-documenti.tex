...
\begin{itemize}
	...
	\item \textbf{nome del gruppo}: per riferirsi al nome del gruppo è necessario utilizzare il comando \glossario{\LaTeX{}} \textbackslash{\texttt{GroupName}} affinché risulti scritto correttamente secondo quanto riportato in \sezione{sec:lettere_maiuscole};
