...
\paragraph{Software di gestione del progetto}\mbox{}\\
...
\subparagraph{Procedure di utilizzo del repository}\mbox{}


\begin{samepage}
	\subsubparagraph{Procedura di clonazione di un Repository:}\mbox{}\\	
	\begin{center}
...
\begin{samepage}
	\subsubparagraph{Procedura di creazione di una Pull Request:}\mbox{}\\
...
\begin{samepage}
	\subsubparagraph{Procedura di tag dell'ultimo commit nel Repository e sua condivisione sul Repository remoto:}\mbox{}\\	
	\begin{center}
...
\begin{samepage}
	\subsubparagraph{Procedura di tag di uno specifico commit nel Repository e sua condivisione sul Repository remoto:}\mbox{}\\	
	\begin{center}
...
\paragraph{Software di integrazione continua}\mbox{}\\
...
\paragraph{Software di pianificazione} \label{sec:teamwork}\mbox{}\\
...
\subparagraph{Modalità di utilizzo} \label{sec:procedure_teamwork}\mbox{}
\begin{samepage}
	\subsubparagraph{Procedura di creazione di un evento:}\mbox{}\\
	\begin{center}
...
\begin{samepage}
	\subsubparagraph{Procedura di creazione di una Milestone:}\mbox{}\\	
	\begin{center}
...
\begin{samepage}
	\subsubparagraph{Procedura di creazione di un Task:}\mbox{}\\
...
\begin{samepage}
	\subsubparagraph{Procedura di modifica di un evento:}\mbox{}\\
...
\begin{samepage}
	\subsubparagraph{Procedura di modifica di un Task:}\mbox{}\\
...
\begin{samepage}
	\subsubparagraph{Procedura di creazione di una riunione interna ordinaria:}\mbox{}\\
...
\begin{samepage}
	\subsubparagraph{Procedura di creazione di una riunione interna di emergenza:}\mbox{}\\
...
\begin{samepage}
	\subsubparagraph{Procedura di creazione di una riunione esterna:}\mbox{}\\
...
\begin{samepage}
	\subsubparagraph{Procedura di segnalazione di assenza da un evento:}\mbox{}\\
...
\subsubparagraph{TeXstudio}\mbox{}\\
...
\subsubparagraph{Google Documents}\mbox{}\\
...
\subsubparagraph{Google Sheets}\mbox{}\\
...
\subsubparagraph{Microsoft Excel} \mbox{}\\
...
\paragraph{Strumenti per lo sviluppo dell'applicazione}\mbox{}\\
...
\paragraph{Strumenti per la codifica}\mbox{}\\
