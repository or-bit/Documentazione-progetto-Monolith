...
Il documento deve essere titolato \textit{Verbale}, seguito dalla tipologia della riunione (\textit{Interna} o \textit{Esterna}) e dalla data del giorno della stessa nel formato AAAA-MM-GG, tutti separati da - (\textit{dash}). Il primo paragrafo deve descrivere l'ordine del giorno trattato nella riunione.\\
...
\subparagraph{Frequenza delle riunioni}\mbox{}\\
...
\subparagraph{Convocazione delle riunioni}\mbox{}\\
...
\subparagraph{Svolgimento delle riunioni}\label{sec:svolgimento_riunioni_interne} \mbox{}\\
...
\subparagraph{Verbale delle riunioni}\label{sec:verbale_riunioni_interne}\mbox{}\\
...
\subparagraph{Riunioni interne d'emergenza}\label{sec:riunioni_emergenza}\mbox{}\\
...
\subparagraph{Svolgimento delle riunioni}\mbox{}\\
...
\subparagraph{Verbale delle riunioni}\mbox{}\\
