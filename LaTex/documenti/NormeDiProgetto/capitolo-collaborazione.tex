...
Il mezzo predefinito per le comunicazioni tra i membri del gruppo è un canale \glossario{Slack}.
...
\paragraph{Convocazione delle riunioni}\mbox{}\\
Secondo quanto indicato da \Proponente{} per comunicare con il Proponente va utilizzato un apposito canale \glossario{Slack}, mentre per il Committente va utilizzato l'indirizzo \email{} \href{mailto:\GroupEmail}{\GroupEmail}.\\
...
Per il versionamento sia dei documenti che del codice sorgente del progetto sono impiegati due \glossario{repository} di \glossario{Git}. Il \glossario{repository} del codice sorgente ha licenza \glossario{MIT} ed è possibile accedervi al seguente indirizzo: \url{https://github.com/or-bit/Monolith}.
...
Il \glossario{repository} dei documenti è suddiviso in due cartelle: 
\begin{itemize}
	\item \textit{Interni}, che contiene tutti i documenti interni;
	\item \textit{Esterni}, che contiene tutti i documenti esterni.
\end{itemize}
Tutti i partecipanti al progetto devono essere aggiunti come collaboratori ai due \glossario{repository}.
