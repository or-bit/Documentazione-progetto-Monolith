...
echo "$bigWords" "big words" 

first=$(($totalWords / $totalSentences))
second=$(($bigWords / $totalWords))
third=$(($first + 100 * $second))
gunningFogIndex=$((4 * $third / 10))

echo "Gunning Fog Index: ""$gunningFogIndex"
